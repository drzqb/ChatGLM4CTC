...
def train():
    ...
    logger.info(
        "基于SoftPrompt 4-bit微调chatglm3实现CTC任务，超参数有--num_samples %d --max_length %d --num_epochs %d --lr %e --batch_size %d --accum_steps %d --train_path %s --model_path %s" % (
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="models/chatglm4ctc51/", type=str)
