...
def train():
    ...
    logger.info(
        "基于QLora 4-bit微调Qwen实现CTC任务，超参设置 --mode train --num_samples %d --max_length %d --num_epochs %d --lr %e --batch_size %d --accum_steps %d --train_path %s --model_path %s" % (
    ...
    pretrained_checkpoint = "D:/pythonwork/huggingfacelesson/uer/Qwen/Qwen-7B-Chat"
    ...
    model.generation_config=GenerationConfig.from_pretrained(pretrained_checkpoint)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="models/qwen4ctc1/", type=str)
